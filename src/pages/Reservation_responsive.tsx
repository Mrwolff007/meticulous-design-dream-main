...
import { ChevronRight, ChevronLeft, Car, User, MapPin, CheckCircle2, Loader2, Fuel, Users, Upload, AlertCircle, Calendar } from "lucide-react";
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
                      {vehicles.map((vehicle) => (
                        ...
                        >
                          <Card
                            className={cn(
                              "cursor-pointer transition-all overflow-hidden h-full",
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-xs md:text-sm">Lieu récupération</FormLabel>
                            <FormControl>
                              <Input
                                placeholder="Aéroport, Gare..."
                                className="text-sm"
                                {...field}
                                onChange={(e) => {
                                  field.onChange(e);
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-xs md:text-sm">Lieu retour</FormLabel>
                            <FormControl>
                              <Input placeholder="Aéroport, Gare..." className="text-sm" {...field} disabled={returnSame} />
                            </FormControl>
                            <FormMessage className="text-xs" />
                          </FormItem>
                        )}
